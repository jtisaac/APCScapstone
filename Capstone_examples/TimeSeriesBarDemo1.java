 ...
 */
public class TimeSeriesBarDemo1 extends ApplicationFrame {
     ...
     */
    public TimeSeriesBarDemo1(String title) {
        super(title);
    ...
    public static void main(String[] args) {
        TimeSeriesBarDemo1 demo = new TimeSeriesBarDemo1(
                "Time Series Bar Demo 1");
        demo.pack();
